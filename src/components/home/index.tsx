...
const Homecomponent = ({ setIsOpen, isOpen }: {
  ...
  return (
    <section id='home' className="h-screen flex items-center justify-between px-3 md:pl-10 bg-neutral-950">
      <div className={` ${isOpen && "hidden"} absolute md:hidden z-50 top-2 right-5 bg-cyan-400 p-2 rounded-full`}>
