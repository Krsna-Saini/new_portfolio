    ...
    const projects = [
        {
            ...
            description:
                'A modern full-stack platform for users to book appointments with lawyers and for advocates to showcase their expertise. Built with Next.js, MongoDB, Tailwind, and Firebase.',
            image: '/bettercallsaul.png',
            link: 'https://better-call-saul-frontend.vercel.app/',
            gradient: 'from-[#fef5ec] to-[#fef5ec]/1',
        ...
        },
        {
            ...
            gradient: 'from-neutral-300 to-white/1',
    ...
    return (
        <section id='portfolio' className="min-h-screen bg-gradient-to-r from-neutral-400 via-neutral-700 to-neutral-800 px-8 py-16 text-white">
            <div className="max-w-6xl mx-auto flex flex-col items-center">
                ...
                <Carousel className="w-full max-w-2xs md:max-w-4xl">
                    <CarouselContent className=" px-4 md:px-8 py-6">
                        {projects.map((project, index) => (
                            <CarouselItem
                                key={index}
                                className="bg-neutral-900/70 mx-3 lg:basis-1/3 basis-1/1 md:basis-1/2 backdrop-blur-md w-70 rounded-2xl shadow-md overflow-hidden transition-transform p-0"
                            >
                                <div className="relative h-full flex flex-col">
                                    ...
                                    <div className="relative  w-full">
                                        <Image
                                            ...
                                            width={500}
                                            height={500}
                                            className="rounded-t-2xl h-90 object-right-top"
                                        />
                                    </div>
                                        ...
                                        <div className="hover:backdrop-blur-sm">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <a
                                                    ...
                                                    className={`text-sm underline transition-all duration-200 hover:text-base ${project.linkColor}`}
                                                >
                                                    <Link />
                                                </a>
                                            </div>
