...
const SubmitButton = () => {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="w-full bg-cyan-500 hover:bg-cyan-600 text-black font-bold py-3 px-6 rounded-xl transition duration-200 disabled:opacity-70"
    >
      {pending ? (
    ...
    >
      <div className="w-full sm:max-w-4xl bg-white/5 backdrop-blur-md rounded-3xl shadow-2xl p-8 md:p-14 border border-white/10">
        <div className="mb-12 text-center">
          <h2 className="text-5xl font-extrabold text-cyan-300 mb-4">📬 Get In Touch</h2>
        ...
        <form action={formAction} className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <input
            ...
            required
            className="col-span-1 md:col-span-2 bg-neutral-800 text-white px-5 py-4 rounded-xl border border-neutral-700 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          />
          <input
            type="email"
            name="email"
            ...
            required
            className="bg-neutral-800 text-white px-5 py-4 rounded-xl border border-neutral-700 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          />
          <input
            type="text"
            name="subject"
